package com.example.activity_7.view
...
import com.example.activity_7.view.route.DestinasiDetailSiswa
import com.example.activity_7.viewmodel.DetailSiswaUiState
import com.example.activity_7.viewmodel.DetailViewModel
import com.example.activity_7.viewmodel.provider.PenyediaViewModel
import com.example.activity_7.viewmodel.toSiswa
...
fun DetailSiswaScreen(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    val id = uiState.detailSiswa.id
                    if (id != 0) {   // ⬅ Prevent crash
